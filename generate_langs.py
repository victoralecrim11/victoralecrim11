...
def build_svg(langs: dict) -> str:
    ...
    el.append(
        ...
        f'font-family="Segoe UI,sans-serif" font-size="10" fill="{TEXT_COLOR}">Top</text>'
    )
    el.append(
        f'  <text x="{CX}" y="{CY + 9}" text-anchor="middle" '
        f'font-family="Segoe UI,sans-serif" font-size="10" fill="{TEXT_COLOR}">Langs</text>'
    )
    ...
    for i, (lang, count) in enumerate(top_n):
        ...
        el += [
            ...
            (
                f'  <text x="{lx + 19}" y="{y + 10}" '
                f'font-family="Segoe UI,sans-serif" font-size="12" fill="{TEXT_COLOR}">'
                f'{lang}</text>'
            ),
            (
                f'  <text x="{W - 16}" y="{y + 10}" text-anchor="end" '
                f'font-family="Segoe UI,sans-serif" font-size="12" font-weight="bold" '
